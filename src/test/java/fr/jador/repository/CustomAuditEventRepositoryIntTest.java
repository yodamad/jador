...
import fr.jador.config.audit.AuditEventConverter;
import fr.jador.domain.PersistentAuditEvent;
...
import static fr.jador.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
