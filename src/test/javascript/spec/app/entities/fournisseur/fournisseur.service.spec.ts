...
describe('Service Tests', () => {
    ...
    describe('Fournisseur Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FournisseurService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/fournisseurs/' + 123);
            });
            it('should return Fournisseur', () => {

                let entity: Fournisseur;
                service.find(123).subscribe((_entity: Fournisseur) => {
                    entity = _entity;
                });
