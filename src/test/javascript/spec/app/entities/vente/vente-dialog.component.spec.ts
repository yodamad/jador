...
import { VenteDialogComponent } from '../../../../../../main/webapp/app/entities/vente/vente-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Vente Management Dialog Component', () => {
        let comp: VenteDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(VenteDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'venteListModification', content: 'OK'});
