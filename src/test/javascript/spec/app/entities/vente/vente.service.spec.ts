...
describe('Service Tests', () => {
    ...
    describe('Vente Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(VenteService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/ventes/' + 123);
            });
            it('should return Vente', () => {

                let entity: Vente;
                service.find(123).subscribe((_entity: Vente) => {
                    entity = _entity;
                });
